...
- 2026-09-05 · **2.2.1 Taxonomy Redesign Fase 2 ✓**: Pobladas TODAS las 30+ entradas del catalog.ts con category (7 categorías), operation (12 verbos), use_cases (descubrimiento semántico). CATEGORY_MAP en backoffice.ts corregido para mapear 7 categorías → 14 servicios técnicos antiguos. Deploy exitoso. Console UI ya muestra dropdowns de "Categoría" en lugar de "Servicio". Backward compatible 100%.
